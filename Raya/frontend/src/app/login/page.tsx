  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center py-10 px-6">
      <div className="w-full max-w-5xl flex justify-between items-center mb-10">
        ...
        <h2 className="text-2xl font-bold text-slate-900">Touch Mode</h2>
      </div>

      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-10">
        
        {/* Left Side: Face Recognition (Silent/Fast path) */}
        <div className="glass-panel p-10 flex flex-col items-center justify-center text-center border-t-4 border-t-emerald-500 relative overflow-hidden">
          <div className="w-64 h-64 rounded-full border-4 border-emerald-500/30 mb-8 flex items-center justify-center bg-emerald-50 relative overflow-hidden">
            <video 
              ref={videoRef}
              autoPlay 
              playsInline 
            ...
            <ScanFace className="w-16 h-16 text-emerald-500/30 absolute z-0" />
          </div>
          <h3 className="text-3xl font-semibold mb-2 text-slate-900">Look at the Camera</h3>
          <p className="text-emerald-700 font-medium mb-4">कैमरे की ओर देखें</p>
        ...
        <div className="glass-panel p-10 border-t-4 border-t-blue-600">
          <h3 className="text-3xl font-semibold mb-2 text-slate-900">Enter ABHA Details</h3>
          <p className="text-blue-700 font-medium mb-8">अपना आभा (ABHA) विवरण दर्ज करें</p>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-xl py-4 pl-12 pr-4 text-slate-900 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all text-lg shadow-sm"
            ...
            <button
              ...
              className="w-full bg-blue-900 hover:bg-blue-800 text-white font-bold py-4 rounded-xl text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-4 shadow-md"
            >
              {loading ? "Verifying..." : "Proceed / आगे बढ़ें"}
            </button>
            {errorMsg && (
              <p className="text-red-500 text-center font-medium mt-2">{errorMsg}</p>
            )}
          </form>

          <div className="mt-8 text-center border-t border-slate-200 pt-6">
            <p className="text-slate-600 mb-4">Don't have an ABHA ID?</p>
            <button 
              onClick={() => router.push('/register')}
              className="text-blue-700 font-semibold hover:text-blue-800 flex items-center justify-center w-full"
            >
